    ...
    <div className="post" data-id={post.id}>
      ...
      <div className="share-icons">
        <i
          ...
          title="Share on X"
          onClick={() => sharePostDirect("twitter", post.id)}
        ></i>
        <i
          className="fab fa-facebook"
          title="Share on Facebook"
          onClick={() => sharePostDirect("facebook", post.id)}
        ></i>
        <i
          className="fab fa-telegram"
          title="Share on Telegram"
          onClick={() => sharePostDirect("telegram", post.id)}
        ></i>
        <i
          className="fab fa-whatsapp"
          title="Share on WhatsApp"
          onClick={() => sharePostDirect("whatsapp", post.id)}
        ></i>
        <i
        ...
        <i
          ...
          onClick={() => downloadPostImage(post.id)}
        ></i>
      </div>
